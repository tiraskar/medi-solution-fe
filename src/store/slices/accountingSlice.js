...
const accountingSlice = createSlice({
    ...
    extraReducers: (builder) => {
        ...
        builder.addCase(getAllLedgerList.pending, (state) => {
            state.loading = true;
            state.isError = false;
            state.error = null;
        ...
        builder.addCase(fetchBankLedger.pending, (state) => {
            state.loading = true;
            state.isError = false;
            state.error = null;
...
export const { clearError, clearSuccess, setPagination, toggleCreateModelOpen,
    toggleSelectedLedger, updatePagination, toggleSelectedLedgerMapping
