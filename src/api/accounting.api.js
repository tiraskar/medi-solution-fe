  ...
  async (_, { rejectWithValue }) => {
    try {
      const response = await getApi({
        url: "api/accounting/getledgergrouplist",
      });
...
export const fetchLedgerSubGroupList = createAsyncThunk(
  ...
  async (_, { rejectWithValue }) => {
    try {
      const response = await getApi({
        url: "api/accounting/getledgersubgrouplist",
      });
      return response?.data;
    } catch (error) {
      return rejectWithValue(error.response.data);
  ...
  async (data, { rejectWithValue, dispatch }) => {
    try {
      ...
      const backendMessage =
        error?.data?.message || error?.message || "Ledger update failed!!!";
...
export const fetchLedgerPagination = createAsyncThunk(
  ...
  async (_, { rejectWithValue, getState }) => {
    try {
      ...
      const params = {
        status: searchFilters.searchStatus,
        page: pagination.page,
        limit: pagination.limit,
        ledgerName: searchFilters.ledgerName,
      };
      const response = await getApi({
        url: "api/accounting/getledgerpagination",
        params,
      });
      return response;
    } catch (error) {
...
export const fetchLedger = createAsyncThunk(
  ...
  async (_, { rejectWithValue }) => {
    try {
      const response = await getApi({
        url: "api/accounting/getallledgerinfo",
      });
      return response;
    } catch (error) {
      return rejectWithValue(error.response.data);
  ...
  async (data, { rejectWithValue, dispatch }) => {
    try {
      const response = await putApi({
        url: "api/accounting/updateledger",
        body: data,
      });
...
export const saveLedgerMapping = createAsyncThunk(
  ...
  async (data, { rejectWithValue, dispatch }) => {
    try {
      const response = await putApi({
        url: "api/accounting/saveledgermapping",
        body: data,
      });
...
export const fetchLedgerMappingPagination = createAsyncThunk(
  ...
  async (_, { rejectWithValue, getState }) => {
    try {
      ...
      const response = await getApi({
        url: "api/accounting/getledgermappingpagination",
        params,
      });
      return response;
    } catch (error) {
